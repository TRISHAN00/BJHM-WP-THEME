 ...
 * Show latest 6 posts in a Swiper slider
 */
...
// 2. SETUP THE QUERY (Latest 6 posts)
$args = array(
...
<section class="py-24 bg-[#FFFEEE] relative overflow-hidden">
    ...
    <div class="absolute -top-20 -left-20 opacity-[0.03] pointer-events-none text-[#ff7722]">
        <i class="fas fa-dharmachakra text-[400px]"></i>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="text-center mb-16">
            <div class="flex items-center justify-center gap-4 mb-4">
                ...
                <div class="text-[#ff7722] text-2xl">
                    <i class="fas fa-om"></i>
                </div>
                <div class="h-[1px] w-12 bg-[#ff7722]/30"></div>
            </div>
        ...
        <div class="swiper activitiesSwiper pb-16">
            <div class="swiper-wrapper">
                ...
                <?php if ($activities_query->have_posts()) : ?>
                    ...
                    wp_reset_postdata(); ?>
                <?php else : ?>
                    <div class="swiper-slide text-center py-20">No activities found.</div>
                <?php endif; ?>
